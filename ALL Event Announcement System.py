...
welcomelabel = Label(homepage, text="Hello", font=("Time New Roman",26,"bold") )
welcomelabel.place(x=1150,y=20)
...
def Login():
    ...
    if e1.get() == '' or e2.get() == '' :
        messagebox.showerror('Error', 'Please complete the required field !')
    elif e1.get() == "Admin12345@newinti.edu.my" and e2.get() == "Admin12345" :
